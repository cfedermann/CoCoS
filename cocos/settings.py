# Django settings for cocos project.
...
STATIC_ROOT = '{0}/static_root'.format(ROOT_PATH)
...
SECRET_KEY = '@qjlopqwm%pn((xjw2fh1sv%m(24dxql6x*z*qpn3=^^yld2*v'
